...
<jsp:include page="../include/main_top.jsp" />
	...
	<c:set var="dto" value="${productCont }"/>
        ...
        <div id ="detail_info">
            ...
            <form method="post" action="<%=request.getContextPath()%>/user_liked_add.do" onsubmit="return submitCheck();">
            	<div class="favorite_main">
            		...
            		<button type="submit" class="favorite_button"><i class="fa-solid fa-heart fa-2x"></i></button>
            	</div>
            </form>
