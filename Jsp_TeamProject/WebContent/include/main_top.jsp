		...
		<div id="userMenu">
			...
			<li class="nav-item dropdown" id="user_menu1">
				...
				<li class="nav-item dropdown" id="menu_comunity">
		          ...
		          <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
		            <li><a class="dropdown-item" href="<%=request.getContextPath() %>/notice_main_list.do">공지사항</a></li>
		            <li><a class="dropdown-item" href="<%=request.getContextPath() %>/notice_inquiry_list.do">1:1문의</a></li>
		          </ul>
			    </li>
			</ul>
		</div>
